...
BEGIN
  ...
  -- Seed tables with PROPER grid positions (not 0,0)
  INSERT INTO public.restaurant_tables (restaurant_id, table_number, seats, status, label, pos_x, pos_y) VALUES
    (v_restaurant_id, 1, 2, 'free', 'Tavolo 1', 15, 20),
    (v_restaurant_id, 2, 4, 'free', 'Tavolo 2', 38, 20),
    (v_restaurant_id, 3, 4, 'occupied', 'Tavolo 3', 62, 20),
    (v_restaurant_id, 4, 6, 'free', 'Tavolo 4', 85, 20),
    (v_restaurant_id, 5, 2, 'occupied', 'Tavolo 5', 15, 60),
    (v_restaurant_id, 6, 4, 'free', 'Tavolo 6', 38, 60),
    (v_restaurant_id, 7, 8, 'free', 'Tavolo 7', 62, 60),
    (v_restaurant_id, 8, 4, 'free', 'Tavolo 8', 85, 60);
...
-- Also fix existing demo restaurant tables that have pos_x=0 and pos_y=0
UPDATE public.restaurant_tables SET pos_x = 15, pos_y = 20 WHERE table_number = 1 AND pos_x = 0 AND pos_y = 0 AND restaurant_id IN (SELECT id FROM public.restaurants WHERE slug LIKE 'demo-partner-%');
UPDATE public.restaurant_tables SET pos_x = 38, pos_y = 20 WHERE table_number = 2 AND pos_x = 0 AND pos_y = 0 AND restaurant_id IN (SELECT id FROM public.restaurants WHERE slug LIKE 'demo-partner-%');
UPDATE public.restaurant_tables SET pos_x = 62, pos_y = 20 WHERE table_number = 3 AND pos_x = 0 AND pos_y = 0 AND restaurant_id IN (SELECT id FROM public.restaurants WHERE slug LIKE 'demo-partner-%');
UPDATE public.restaurant_tables SET pos_x = 85, pos_y = 20 WHERE table_number = 4 AND pos_x = 0 AND pos_y = 0 AND restaurant_id IN (SELECT id FROM public.restaurants WHERE slug LIKE 'demo-partner-%');
UPDATE public.restaurant_tables SET pos_x = 15, pos_y = 60 WHERE table_number = 5 AND pos_x = 0 AND pos_y = 0 AND restaurant_id IN (SELECT id FROM public.restaurants WHERE slug LIKE 'demo-partner-%');
UPDATE public.restaurant_tables SET pos_x = 38, pos_y = 60 WHERE table_number = 6 AND pos_x = 0 AND pos_y = 0 AND restaurant_id IN (SELECT id FROM public.restaurants WHERE slug LIKE 'demo-partner-%');
UPDATE public.restaurant_tables SET pos_x = 62, pos_y = 60 WHERE table_number = 7 AND pos_x = 0 AND pos_y = 0 AND restaurant_id IN (SELECT id FROM public.restaurants WHERE slug LIKE 'demo-partner-%');
UPDATE public.restaurant_tables SET pos_x = 85, pos_y = 60 WHERE table_number = 8 AND pos_x = 0 AND pos_y = 0 AND restaurant_id IN (SELECT id FROM public.restaurants WHERE slug LIKE 'demo-partner-%');
