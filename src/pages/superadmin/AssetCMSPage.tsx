...
export default function AssetCMSPage() {
  ...
  return (
    <div className="min-h-screen text-foreground p-4 pb-24 landing-dark force-dark" style={{ background: "linear-gradient(145deg, hsl(228 22% 6%) 0%, hsl(230 20% 7%) 40%, hsl(228 18% 8%) 100%)" }}>
      {/* Header */}
