            ...
            <motion.div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-4 max-w-3xl mx-auto mb-6" variants={staggerContainer} initial="hidden" whileInView="visible" viewport={{ once: true, margin: "-50px" }}>
              {PLAN_TIERS.map((p) => {const isSelected = selectedPlan === p.id;const displayPrice = Math.round(p.price * planDiscount);const isEnterprise = p.id === "enterprise";return (
                  ...
                  style={{
                    ...
                    {/* CTA */}
                    <motion.button
                    onClick={(e) => {e.stopPropagation();setSelectedPlan(p.id);navigate("/auth?plan=" + p.id + "navigate("/auth?plan=" + p.id + "navigate("/auth?plan=" + p.id);sector=" + selectedSector);sector=" + selectedSector);}}
    ...
    <div
                ...
                {painData.map((pain, i) =>
                  <motion.div
                    ...
                    <div className="relative rounded-lg sm:rounded-xl border overflow-hidden h-full" style={{
                      background: "linear-gradient(160deg, hsl(228 20% 14% / 0.86), hsl(248 15% 97% / 0.93))",
      ...
      <Section className="relative overflow-hidden hidden" style={{
        ...
        <div className="sm:hidden relative py-4 px-1">
          ...
          style={{ background: "linear-gradient(180deg, hsl(228 20% 14% / 0.85), hsl(248 15% 97% / 0.93))", border: "1px solid hsl(var(--border) / 0.3)" }} />
      ...
      {/* ═══════════════════════════════════════════
                            ═══════════════════════════════════════════ */}
      <Section id="process" className="relative overflow-hidden hidden" style={{
        ...
        <div className="relative mb-1 rounded-2xl overflow-hidden isolate">
          ...
          <div
            ...
            style={{
              background: "linear-gradient(160deg, hsl(228 20% 14% / 0.88), hsl(248 15% 97% / 0.95))",
