  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden relative">
      ...
      {/* ═══════════════════════════════════════════
          1. HERO
         ═══════════════════════════════════════════ */}
      <section id="hero" className="relative min-h-screen flex items-center justify-center overflow-hidden px-5 sm:px-6">
        <div className="absolute inset-0 bg-gradient-to-b from-background via-background/95 to-background" />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] sm:w-[900px] h-[400px] sm:h-[600px] bg-violet-600/15 rounded-full blur-[180px]" />
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute w-[150px] h-[150px] rounded-full border border-primary/[0.06] top-[40%] right-[25%] animate-blob-float-slow" />
        </div>

        <div className="relative z-10 max-w-6xl mx-auto w-full flex flex-col lg:flex-row items-center gap-10 lg:gap-16 pt-28 sm:pt-32 pb-12">
          {/* Left */}
          <div className="flex-1 flex flex-col items-center lg:items-start text-center lg:text-left">
            <motion.div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/25 mb-6"
              initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }}>
              <span className="w-2 h-2 rounded-full bg-accent animate-pulse-dot" />
              <span className="text-xs font-medium text-primary/80 tracking-wider uppercase font-heading">AI-Powered Restaurant Suite</span>
            </motion.div>

            <motion.h1
              className="text-[2.2rem] leading-[1.08] sm:text-5xl md:text-6xl lg:text-7xl font-heading font-bold text-foreground tracking-tight"
            ...
            <motion.p className="mt-5 sm:mt-7 text-sm sm:text-lg text-foreground/60 max-w-xl leading-relaxed"
            ...
            <motion.div className="mt-7 sm:mt-9 flex flex-col sm:flex-row items-center gap-3 w-full sm:w-auto"
              initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.6 }}>
              <button onClick={() => scrollTo("pricing")}
                className="group relative w-full sm:w-auto px-8 sm:px-10 py-4 rounded-full bg-vibrant-gradient text-primary-foreground font-bold text-sm tracking-widest uppercase font-heading overflow-hidden transition-transform hover:-translate-y-0.5 hover:shadow-[0_12px_40px_hsla(263,70%,58%,0.4)]">
                Prenota una Demo <ArrowRight className="inline w-4 h-4 ml-2 group-hover:translate-x-1 transition-transform" />
              </button>
              <button onClick={() => navigate("/r/impero-roma")}
                className="w-full sm:w-auto px-8 py-4 rounded-full glass text-foreground text-sm font-bold tracking-widest uppercase font-heading hover:border-primary/40 transition-all flex items-center justify-center gap-2">
                <Play className="w-4 h-4 text-accent" /> Scopri i Servizi
              </button>
            </motion.div>

            {/* Hero stats */}
            <motion.div className="mt-10 sm:mt-14 flex flex-wrap items-center justify-center lg:justify-start gap-8 sm:gap-12 pt-8 border-t border-border/30 w-full"
              ...
              {[
                ...
                <div key={i} className="text-center lg:text-left">
                  <p className="text-2xl sm:text-3xl font-heading font-bold text-vibrant-gradient">{s.value}</p>
          ...
          <motion.div className="flex-shrink-0 relative"
            ...
            <div className="absolute -inset-10 bg-violet-600/15 rounded-[60px] blur-[80px]" />
        ...
        <motion.div className="absolute bottom-6 sm:bottom-10 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1"
