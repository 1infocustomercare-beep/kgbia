    ...
    <div className="min-h-screen flex flex-col items-center justify-center px-6 relative overflow-hidden landing-dark auth-contrast">
      ...
      <motion.div className="w-full max-w-sm space-y-6 relative z-10" initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
        ...
        <form onSubmit={handleOwnerLogin} className="space-y-3">
                ...
                <>
                  ...
                  <div>
                    ...
                    <select value={partnerSector} onChange={e => setPartnerSector(e.target.value)}
                      className="w-full px-4 py-3 rounded-xl bg-white border border-white/20 !text-black text-base focus:outline-none focus:ring-2 focus:ring-primary/30">
          ...
          <div>
            <label className="text-xs text-foreground/90 uppercase tracking-wider block mb-1.5">Password</label>
