  ...
  const [apis, setApis] = useState<ApiStatus[]>([
    {
      ...
      setupSteps: [
        "Vai su firecrawl.dev e crea un account senza costi (500 scrape/mese inclusi)",
    ...
    },
    {
      ...
      icon: Instagram,
      status: "missing",
      costPerCall: "Omaggio (rate limit)",
      ...
      setupSteps: [
        ...
        "OPZIONALE: Empire usa Firecrawl come fallback senza costi",
      ],
    ...
    },
    {
      ...
      setupSteps: [
        ...
        "Empire fornisce alternativa via Firecrawl scraping pubblico (omaggio ma più lento)",
      ],
    ...
    },
    {
      ...
      icon: Mail,
      status: "missing",
      costPerCall: "Omaggio fino a 3.000 email/mese, poi $20/mese (50K)",
      requiredFor: ["Arianna Outreach Email", "Follow-up automatici", "Mockup preview email"],
      setupSteps: [
        "Vai su resend.com e crea un account senza costi",
    ...
    },
    {
      ...
      icon: Facebook,
      status: "missing",
      costPerCall: "Omaggio (rate limit Meta)",
