...
const VARIANT_MAP: Record<string, VariantConfig> = {
  ...
  "neo-nails-lavender": {
    sectorId: "beauty",
    brand: "Aurora Nail Atelier",
    style: "Lavender Luxe",
    label: "Atelier Unghie Lavender",
    accent: "267 47% 63%",
  ...
  "neo-nails-blush": {
    ...
    label: "Atelier Unghie Blush",
    accent: "338 48% 57%",
    screenLabels: ["Home", "Servizi", "Dettaglio", "Booking"],
  },
  "tatush-hair": {
    sectorId: "beauty",
    brand: "Velluto Hair Lab",
    style: "Mobile",
    label: "Essenza Fragrance",
    accent: "43 52% 54%",
    screenLabels: ["Home", "Shop", "Dettaglio", "Carrello"],
  },
  "asinara-azure": {
    sectorId: "ncc",
    brand: "Cala Vento Charter",
