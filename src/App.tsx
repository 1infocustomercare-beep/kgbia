...
const SHOULD_SKIP_INTRO_DEFAULT = typeof window !== "undefined" &&
  (window.location.pathname === "/" ||
    ...
    /^\/(r|b|demo\/|portfolio|superadmin|admin|auth|login|reset-password|kitchen|partner\/register|partner|join|onboarding|t\/|pacchetto-|vendor|privacy|cookie-policy|termini|note-legali|contatti|chi-siamo)/.test(window.location.pathname));
...
const HomepageEditorPage = lazy(() => import("./pages/superadmin/HomepageEditorPage"));
const HomepageMediaManagerPage = lazy(() => import("./pages/superadmin/HomepageMediaManagerPage"));
        ...
        <TooltipProvider>
          <AuthProvider>
            <CartProvider>
              <Toaster />
              <Sonner />
              {/* Banner consenso cookie GDPR — globale, riapribile da "Gestisci cookie" */}
              <CookieBanner />
                ...
                <RouteErrorBoundary>
                  <Suspense fallback={<PageLoader />}>
                    <Routes>
                      ...
                      {/* Click su uno stile dal portfolio → pagina categoria del settore. */}
                      ...
                      <Route path="/superadmin/costs" element={
                        <ProtectedRoute requiredRole="super_admin">
                          <SuperAdminCostsPage />
                        </ProtectedRoute>
                      } />
                      <Route path="/superadmin/homepage-editor" element={
                        <ProtectedRoute requiredRole="super_admin">
                          <HomepageEditorPage />
                        </ProtectedRoute>
                      } />
