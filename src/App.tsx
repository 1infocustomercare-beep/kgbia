...
const EmpireHomePage = lazy(() => import("./pages/empire/EmpireHomePage"));
              ...
              <BrowserRouter>
                ...
                <RouteErrorBoundary>
                  <Suspense fallback={<PageLoader />}>
                    <Routes>
                      {/* Public routes */}
                      <Route path="/" element={<EmpireHomePage />} />
                      <Route path="/index" element={<EmpireHomePage />} />
                      <Route path="/home" element={<EmpireHomePage />} />
