...
export const DEMO_INDUSTRY_DATA: Record<IndustryId, DemoIndustryData> = {
  ...
  ncc: {
    companyName: "Amalfi Luxury Transfer",
    tagline: "Il tuo transfer privato in Costiera Amalfitana",
    heroTitle: "Luxury NCC Transport",
    heroSubtitle: "Trasferimenti premium lungo la Costiera Amalfitana e il Sud Italia",
    address: "Maiori, Costiera Amalfitana",
    city: "Maiori",
    phone: "+39 089 123 4567",
    email: "info@amalfiluxurytransfer.it",
    ...
    services: [
      { name: "Transfer Aeroporto Napoli", description: "Mercedes S-Class, meet & greet incluso", price: 120, category: "Aeroporti", popular: true, emoji: "✈️" },
      { name: "Transfer Roma → Amalfi", description: "Berlina o van premium, autostrada inclusa", price: 280, category: "Interurbani", emoji: "🚗" },
      { name: "Tour Costiera Amalfitana", description: "Giornata intera con autista dedicato", price: 350, category: "Tour", popular: true, emoji: "🏖️" },
      { name: "Boat Tour Capri", description: "Transfer + tour in barca privata", price: 450, category: "Tour", emoji: "⛵" },
      { name: "Transfer Positano", description: "Servizio porta a porta dalla stazione", price: 90, category: "Costiera", emoji: "🌊" },
      { name: "Disposizione Oraria", description: "Autista dedicato, min. 3 ore", price: 70, duration: "/ora", category: "Business", emoji: "⏰" },
    ],
    reviews: [
      { name: "Marco R.", rating: 5, comment: "Servizio impeccabile, Mercedes perfetta." },
      { name: "Sophie L.", rating: 5, comment: "Best transfer service on the Amalfi Coast!" },
      { name: "Anna M.", rating: 5, comment: "Autista puntuale e gentilissimo." },
    ],
    features: [
      ...
      { icon: "Star", label: "Flotta Premium", desc: "Mercedes S-Class, V-Class, BMW Serie 7" },
    ],
  },
