...
export const SECTOR_OPTIONS = [
  ...
  { value: "healthcare", label: "🏥 Sanità & Medici" },
  { value: "retail", label: "🛍️ Retail & Negozi" },
  { value: "fitness", label: "💪 Fitness & Palestre" },
  { value: "hospitality", label: "🏨 Hotel & B&B" },
  { value: "beach", label: "🏖️ Stabilimenti Balneari" },
  { value: "plumber", label: "🔧 Idraulica" },
  { value: "electrician", label: "⚡ Elettricista" },
  { value: "construction", label: "🏗️ Edilizia & Ristrutturazioni" },
  { value: "gardening", label: "🌿 Giardinaggio & Verde" },
  { value: "veterinary", label: "🐾 Veterinaria & Pet" },
  { value: "tattoo", label: "🎨 Tattoo & Piercing" },
  { value: "photography", label: "📷 Fotografia & Video" },
  { value: "events", label: "🎉 Eventi & Wedding" },
  { value: "logistics", label: "📦 Logistica & Spedizioni" },
  { value: "childcare", label: "👶 Asili & Infanzia" },
  { value: "education", label: "📚 Formazione & Corsi" },
  { value: "legal", label: "⚖️ Studi Legali & Notai" },
  { value: "accounting", label: "📊 Commercialisti & CAF" },
  { value: "agriturismo", label: "🌾 Agriturismo & Cantina" },
  { value: "cleaning", label: "🧹 Pulizie & Sanificazione" },
  { value: "garage", label: "🔩 Autofficine & Carrozzerie" },
  { value: "bakery", label: "🥐 Panetterie & Pasticcerie" },
  { value: "pharmacy", label: "💊 Farmacie & Parafarmacie" },
  { value: "optics", label: "👓 Ottiche & Occhiali" },
  { value: "dentist", label: "🦷 Dentisti & Ortodonzia" },
  { value: "physiotherapy", label: "🧑‍⚕️ Fisioterapia & Osteopatia" },
  { value: "psychology", label: "🧠 Psicologi & Terapeuti" },
  { value: "insurance", label: "🛡️ Assicurazioni & Broker" },
  { value: "real_estate", label: "🏠 Immobiliare & Agenzie" },
  { value: "architect", label: "📐 Architetti & Interior" },
  { value: "coworking", label: "🏢 Coworking & Uffici" },
  { value: "laundry", label: "👔 Lavanderie & Tintorie" },
  { value: "florist", label: "💐 Fioristi & Vivai" },
  { value: "jewelry", label: "💎 Gioiellerie & Orefici" },
  { value: "pet_shop", label: "🐶 Pet Shop & Toelettatura" },
  { value: "travel", label: "✈️ Agenzie Viaggi & Tour" },
  { value: "music", label: "🎵 Scuole Musica & Studi" },
  { value: "dance", label: "💃 Scuole Danza & Ballo" },
  { value: "martial_arts", label: "🥋 Arti Marziali & MMA" },
  { value: "barber", label: "💈 Barbiere & Grooming" },
  { value: "spa", label: "🧖 Spa & Centro Benessere" },
  { value: "car_wash", label: "🚿 Autolavaggi" },
  { value: "tech_repair", label: "📱 Riparazione Telefoni & PC" },
  { value: "printing", label: "🖨️ Tipografie & Stampa" },
  { value: "catering", label: "🍱 Catering & Banqueting" },
  { value: "wine_bar", label: "🍷 Enoteche & Wine Bar" },
  { value: "gelateria", label: "🍨 Gelaterie & Yogurterie" },
  { value: "driving_school", label: "🚗 Autoscuole" },
  { value: "funeral", label: "⚱️ Onoranze Funebri" },
  { value: "moving", label: "🚚 Traslochi & Sgomberi" },
  { value: "pest_control", label: "🐜 Disinfestazione" },
  { value: "locksmith", label: "🔑 Fabbri & Serrature" },
  { value: "tailor", label: "✂️ Sartorie & Atelier" },
  { value: "custom", label: "📌 Altro settore" },
];
