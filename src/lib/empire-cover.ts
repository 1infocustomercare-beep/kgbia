...
const POOL_FOOD    = [restaurantHero, restaurantDish];
const POOL_SUSHI   = [sushiHero, sushiDish];
const POOL_NCC     = [nccHero, nccDetail];
const POOL_BOAT    = [hospitalityHero, hospitalityDetail, beachHome, beachBooking];
const POOL_BEAUTY  = [beautyHero, beautyDish];
const POOL_HOTEL   = [hospitalityHero, hospitalityDetail, agriturismoHome, agriturismoRooms];
const POOL_FITNESS = [fitnessHero, fitnessDish];
const POOL_REAL    = [realestateHero, realestateDish];
const POOL_RETAIL  = [retailHome, retailDetail];
const POOL_ELEC    = [electricianHome, electricianDetail, electricianServices];
const POOL_AGRI    = [agriturismoHome, agriturismoActs, agriturismoRooms];
...
const POOL_BEACH   = [beachHome, beachBooking];
const POOL_HEALTH  = [beautyHero, accountingHome, legalDeadlines];
