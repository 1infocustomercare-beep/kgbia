...
const ALL_AGENTS: AgentNode[] = [
  ...
  { id: "aftercare-ai", name: "Aftercare AI", role: "Cura Post-Tattoo", desc: "Invia istruzioni di cura personalizzate e reminder follow-up.", whyNeed: "Un tattoo mal curato = reclamo e ritocco omaggio.", icon: <ShieldCheck className="w-5 h-5" />, gradient: "from-teal-400 to-cyan-500", glow: "hsla(180,70%,50%,1)", stat: { value: 0, suffix: "", label: "Ritocchi omaggio" }, capabilities: ["Istruzioni personalizzate", "Reminder cura", "Follow-up foto", "Garanzia digitale"], category: "operations", sectors: ["tattoo"], connections: ["concierge-ai", "smart-agenda"], features: [] },
