...
const TEAM = [
  {
    ...
    role: "CEO & Founder",
    photo: teamKevin,
    bio: "Imprenditore con oltre 10 anni di esperienza nel settore digitale e nell'automazione dei processi aziendali. Ha fondato Empire AI con la missione di rendere l'intelligenza artificiale accessibile e concreta per le piccole e medie imprese italiane, trasformando la tecnologia in vantaggio competitivo reale.",
  ...
  },
  {
    ...
    bio: "Ingegnere software con esperienza pluriennale nella progettazione di piattaforme SaaS enterprise. Responsabile dell'architettura multi-tenant scalabile che consente a Empire AI di servire simultaneamente oltre 25 settori industriali con infrastruttura cloud-native.",
  ...
  },
  {
    ...
    role: "Head of Design",
    photo: teamMarco,
    bio: "Product designer specializzato in interfacce B2B complesse. Guida il team UX nella creazione di dashboard e flussi operativi che riducono i tempi di apprendimento e aumentano l'adozione da parte degli utenti finali.",
  ...
  },
  {
    ...
    role: "Head of Sales",
    photo: teamGiulia,
    bio: "Professionista del business development B2B con un track record di oltre 200 aziende acquisite in 18 mesi. Coordina la rete commerciale e il programma partner su scala nazionale, dal primo contatto alla firma del contratto.",
  ...
  },
  {
    ...
    photo: teamLuca,
    bio: "Dottore di ricerca in Machine Learning con pubblicazioni in NLP e computer vision. Progetta e ottimizza il portfolio di oltre 95 agenti IA verticali, ciascuno calibrato sulle esigenze operative specifiche di ogni settore.",
  ...
  },
  {
    ...
    photo: teamSofia,
    bio: "Responsabile dell'esperienza cliente post-vendita. Gestisce onboarding strutturati, sessioni di formazione periodiche e un programma di supporto dedicato per garantire che ogni azienda raggiunga il massimo ROI dalla piattaforma.",
