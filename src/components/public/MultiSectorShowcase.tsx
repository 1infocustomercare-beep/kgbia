    ...
    <>
      ...
      <div className="flex items-center justify-center gap-1.5 sm:gap-2 mb-5 sm:mb-8 flex-wrap">
        <button
          ...
          className="w-8 h-8 rounded-full border border-border/20 flex items-center justify-center text-foreground/80 hover:text-foreground/70 hover:border-border/40 transition-all bg-background/5"
        >
        ...
        <button
          ...
          className={`w-8 h-8 rounded-full border flex items-center justify-center transition-all ${
            isAutoPlaying 
              ...
              : "border-border/20 text-foreground/80 hover:text-foreground/70 hover:border-border/40 bg-background/5"
          }`}
        >
          ...
          >
            <div className="rounded-2xl border border-border/15 backdrop-blur-md p-4"
              ...
              <div className="flex items-center justify-between mb-4">
                ...
                <button onClick={() => setShowAllSectors(false)} className="w-6 h-6 rounded-full border border-border/20 flex items-center justify-center text-foreground/75 hover:text-foreground/60 transition-all">
                  <X className="w-3 h-3" />
                </button>
              </div>
      ...
      <AnimatePresence mode="sync">
        <motion.div key={sector.id}
          ...
          <div className="text-center lg:text-left">
            ...
            <p className="text-foreground/80 leading-[1.6] max-w-lg mx-auto lg:mx-0 mb-5 sm:mb-7 text-xs sm:text-sm">{sector.desc}</p>
                          ...
                          <div className="transform scale-[0.6] sm:scale-[0.7] origin-top">
                            {industryCfg && demoData ? (
                              ...
                              <div className="w-[160px] h-[320px] rounded-2xl flex items-center justify-center"
                                ...
                                <span className="text-foreground/75 text-xs">{screen.label}</span>
                              </div>
                            )}
                          </div>
      ...
      <motion.div className="text-center mt-8 sm:mt-12 pt-6 sm:pt-8 border-t border-border/10"
        ...
        <p className="text-foreground/25 text-xs font-heading tracking-wider uppercase">
          <span style={{ color: "hsl(38,45%,52%)" }}>{SHOWCASE_SECTORS.length} settori</span> · 95+ Agenti IA · 1 piattaforma · <span className="text-foreground/80">il tuo brand</span>
        </p>
      </motion.div>
    </>
  );
