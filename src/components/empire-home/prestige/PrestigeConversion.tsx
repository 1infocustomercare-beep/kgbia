...
export function PrestigePricing() {
  ...
  const plans = [
    {
      name: { it: "Start", en: "Start" }, price: "€97", per: { it: "/mese", en: "/month" },
      desc: { it: "Per partire subito con sito + AI WhatsApp.", en: "Get started fast with website + WhatsApp AI." },
      feats: [
        { it: "Sito professionale", en: "Pro website" },
        { it: "AI WhatsApp 24/7", en: "24/7 WhatsApp AI" },
        { it: "1 lingua", en: "1 language" },
        { it: "Email support", en: "Email support" },
      ],
      highlight: false,
    },
    {
      name: { it: "Empire", en: "Empire" }, price: "€297", per: { it: "/mese", en: "/month" },
      desc: { it: "Il piano scelto dal 78% dei nostri clienti.", en: "The plan chosen by 78% of our customers." },
      feats: [
        { it: "Tutto di Start, più:", en: "Everything in Start, plus:" },
        { it: "Centralino AI vocale", en: "AI voice switchboard" },
        { it: "App clienti + prenotazioni", en: "Customer app + bookings" },
        { it: "Pagamenti integrati", en: "Integrated payments" },
        { it: "Multilingua + CRM", en: "Multilingual + CRM" },
        { it: "Support dedicato 7/7", en: "Dedicated 7/7 support" },
      ],
      highlight: true, badge: { it: "Consigliato", en: "Recommended" },
    },
    {
      name: { it: "Luxury", en: "Luxury" }, price: { it: "Su misura", en: "Bespoke" }, per: "",
      desc: { it: "Multi-sede, brand custom, account manager.", en: "Multi-location, custom brand, account manager." },
      feats: [
        { it: "Tutto di Empire, più:", en: "Everything in Empire, plus:" },
        { it: "Brand & design custom", en: "Custom brand & design" },
        { it: "Multi-sede", en: "Multi-location" },
        { it: "Account manager", en: "Account manager" },
        { it: "SLA premium", en: "Premium SLA" },
      ],
      highlight: false,
    },
  ];
