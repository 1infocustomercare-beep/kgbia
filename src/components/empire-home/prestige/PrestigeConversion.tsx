...
export function PrestigeFAQ() {
  ...
  const faqs = [
    ...
    { q: { it: "Quanto costa e cosa comprende?", en: "How much is it and what's included?" }, a: { it: "Tre piani chiari: Digital Start €1.997 una tantum + Canone Manutenzione €49/mese, Growth AI €4.997 + Canone Manutenzione €29/mese, Empire Domination €7.997 + Canone Manutenzione €0/mese. Prezzi senza applicazione dell'IVA (regime forfettario, art. 1 commi 54-89 L. 190/2014), rateizzabili. Nessun costo nascosto: quello che vedi è quello che paghi.", en: "Three clear plans: Digital Start €1,997 one-off + €49/month maintenance fee, Growth AI €4,997 + €29/month maintenance fee, Empire Domination €7,997 + €0/month maintenance fee. No VAT applied (Italian flat-rate scheme, art. 1 §54-89 L. 190/2014), instalments available. No hidden fees." } },
