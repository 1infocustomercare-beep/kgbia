  ...
  const plans = [
    {
      ...
      desc: { it: "Setup completo con sito, app white-label e dashboard operativa.", en: "Full setup with website, white-label app and operational dashboard." },
      feats: [
        { it: "Setup completo", en: "Full setup" },
        { it: "App white-label", en: "White-label app" },
        { it: "Dashboard operativa", en: "Operational dashboard" },
    ...
    },
    {
      ...
      desc: { it: "Il piano più scelto: AI, automazioni e CRM avanzato inclusi.", en: "Most chosen plan: AI, automations and advanced CRM included." },
      feats: [
        { it: "Tutto di Digital Start", en: "Everything in Digital Start" },
        { it: "AI & automazioni", en: "AI & automations" },
        { it: "CRM avanzato", en: "Advanced CRM" },
        { it: "Supporto prioritario", en: "Priority support" },
      ],
      highlight: true, badge: { it: "Popolare", en: "Popular" },
    },
    {
      name: { it: "Empire Domination", en: "Empire Domination" },
      price: "€7.997",
      per: { it: " una tantum + €0/mese", en: " one-off + €0/month" },
      desc: { it: "Tutto incluso, 0% commissioni e account manager dedicato.", en: "Everything included, 0% fees and a dedicated account manager." },
      feats: [
        { it: "Tutto incluso", en: "Everything included" },
        { it: "0% commissioni", en: "0% fees" },
        { it: "AI avanzata", en: "Advanced AI" },
        { it: "Account manager dedicato", en: "Dedicated account manager" },
      ],
      highlight: false,
    },
  ];
