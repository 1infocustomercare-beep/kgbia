...
export default function LandingHero() {
  ...
  return (
    ...
    >
      ...
      {/* MAIN CONTENT */}
      <div className="relative z-[2] flex-1 flex flex-col justify-center items-center pt-[130px] pb-8 px-5">
        <motion.div style={{ y: titleY }} className="text-center max-w-[900px] mx-auto mb-8 lg:mb-12">
          {/* Badge */}
          <motion.div
        ...
        {/* MOCKUP FAN — scroll-driven with whileInView */}
        <motion.div
          style={{ y: mockupY }}
