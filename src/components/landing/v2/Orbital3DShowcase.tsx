...
const MOCKUPS: Mockup[] = [
  ...
  { brand: "Studio Medico Aurora", sector: "Healthcare premium", metric: "GDPR", metricLabel: "compliance totale", img: `${S}/Lumen%20Clinic/a-ethereal-glass-mobile-home.png`, accent: "172 80% 58%", tagline: "Studio medico · cartella crittografata", features: ["Cartella crypto", "Telemedicina", "GDPR ready"] },
