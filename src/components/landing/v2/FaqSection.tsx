...
const FAQ = [
  ...
  { q: "Devo avere competenze tecniche per usarlo?", a: "Zero. Tutto si gestisce da WhatsApp con comandi vocali o testuali, oppure dalla dashboard visuale. Il tuo Account Manager ti segue passo-passo nei primi 30 giorni." },
  { q: "I dati dei miei clienti sono al sicuro?", a: "Infrastruttura enterprise europea, conformità GDPR totale, crittografia end-to-end e backup automatici giornalieri. Empire è già operativa nei settori più sensibili." },
  { q: "Posso integrare Empire con il mio gestionale o POS?", a: "Sì. Integriamo sistemi esistenti come POS, gestionali, CRM, marketplace, fatturazione elettronica, calendari e WhatsApp Business." },
  { q: "Cosa include il canone mensile di mantenimento?", a: "Hosting premium, aggiornamenti continui agli agenti AI, nuove funzionalità, supporto tecnico, monitoraggio KPI e nuove integrazioni." },
  { q: "Posso cambiare pacchetto in corsa?", a: "Sì. Upgrade in qualsiasi momento e downgrade al rinnovo successivo, con massima flessibilità per scalare al ritmo del tuo business." },
];
      ...
      <div className="relative mx-auto max-w-[900px]">
        ...
        <div className="space-y-3">
          {FAQ.map((f, i) => (
            ...
            >
              <button onClick={() => setOpen(open === i ? null : i)} className="group flex w-full items-center justify-between gap-4 px-5 py-4 text-left sm:px-6 sm:py-[1.125rem]">
                ...
                <motion.span animate={{ rotate: open === i ? 45 : 0 }} transition={{ duration: 0.3 }} className="landing-icon-frame h-8 w-8 flex-shrink-0 rounded-full">
              ...
              <AnimatePresence>
                {open === i && (
                  ...
                  >
                    <div className="px-5 pb-5 text-[14px] leading-[1.68] text-foreground/78 sm:px-6">{f.a}</div>
                  </motion.div>
                )}
              </AnimatePresence>
            </motion.div>
