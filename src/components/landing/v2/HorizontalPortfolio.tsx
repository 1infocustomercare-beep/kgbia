...
const PROJECTS = [
  ...
  { brand: "Atelier Unghie", sector: "Beauty studio", img: `${S}/Aurora%20Nail%20Atelier/frosted-glass-home.png`, accent: "325 75% 66%", tone: "blue", result: "3.2×", metric: "retention clienti", quote: "Frosted glass UI, retention da boutique." },
