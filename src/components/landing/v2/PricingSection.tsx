  ...
  return (
    <section id="prezzi" className="landing-section relative overflow-visible px-4 py-10 sm:px-6 sm:py-14 lg:px-10 lg:py-16" data-theme="light">
      ...
      <div className="relative mx-auto max-w-[1320px]">
        <div className="mx-auto mb-7 max-w-[760px] text-center" data-tone="gold">
          ...
          <p className="mt-4 text-[clamp(0.94rem,1.55vw,1rem)] leading-[1.68] text-foreground/80">
            Setup una tantum rateizzabile + mantenimento continuo: agenti AI, hosting premium, aggiornamenti e supporto dedicato.
          </p>
        </div>
              ...
              <div className="flex w-full flex-col">
                <div className="mb-5 flex items-start justify-between gap-3">
                  <div>
                    ...
                    <p className="mt-3 max-w-[32ch] text-sm leading-[1.68] text-foreground/78">{plan.desc}</p>
                  </div>
                  {plan.badge ? <span className="landing-pill px-3 py-1.5 text-[10px] font-bold uppercase tracking-[0.18em]">{plan.badge}</span> : null}
                </div>

                <div className="mb-5 rounded-[22px] border border-border/75 bg-background/84 p-4 backdrop-blur-xl sm:p-5">
