  ...
  return (
    <section className="pglass-scope pglass-bg min-h-screen pb-28 pt-28 text-white sm:pt-32">
      <div className="mx-auto max-w-7xl px-5 lg:px-10">
        ...
        {/* Sector filter */}
        <div className="pglass-scroll-x mb-4 -mx-5 flex snap-x gap-2 overflow-x-auto px-5 pb-1 [scrollbar-width:none] [&::-webkit-scrollbar]:hidden sm:mx-0 sm:flex-wrap sm:overflow-visible sm:px-0">
          {sectors.map((s) => {
