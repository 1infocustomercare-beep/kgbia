      ...
      >
        ...
        <div className="grid grid-cols-2 gap-3 mb-4">
          <div className="p-3 rounded-xl bg-muted/30 border border-border/30 text-center">
            <p className="text-lg font-display font-bold text-foreground">€1.099</p>
            <p className="text-[10px] text-muted-foreground">x 3 mesi</p>
            <p className="text-[10px] text-primary font-semibold mt-1">Totale: €3.297</p>
          </div>
          <div className="p-3 rounded-xl bg-muted/30 border border-border/30 text-center">
            <p className="text-lg font-display font-bold text-foreground">€549</p>
            <p className="text-[10px] text-muted-foreground">x 6 mesi</p>
            <p className="text-[10px] text-primary font-semibold mt-1">Totale: €3.294</p>
          </div>
        </div>
