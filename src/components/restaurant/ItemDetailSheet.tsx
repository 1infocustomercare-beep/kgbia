              ...
              <div className="px-5 -mt-6 relative z-10 pb-4">
                ...
                <div className="mt-5">
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-secondary/50 text-foreground text-base placeholder:text-muted-foreground/75 resize-none h-20 focus:outline-none focus:ring-1 focus:ring-primary/30"
                  />
                </div>
              </div>
            </div>
