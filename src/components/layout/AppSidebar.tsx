...
const INDUSTRY_NAV: Record<string, { title: string; icon: string; url: string }[]> = {
  ...
  beauty: [
    ...
    { title: "Staff", icon: "UserCog", url: "/app/staff" },
  ...
  beach: [
    ...
    { title: "Abbonamenti", icon: "CreditCard", url: "/app/beach-passes" },
    { title: "Ospiti", icon: "Users", url: "/app/clients" },
    { title: "Staff", icon: "UserCog", url: "/app/staff" },
    { title: "Recensioni", icon: "Star", url: "/app/reviews" },
    { title: "Sito Web", icon: "Store", url: "/app/webhub" },
  ...
  veterinary: [
    ...
    { title: "Farmaci", icon: "Package", url: "/app/inventory" },
    { title: "Recensioni", icon: "Star", url: "/app/reviews" },
    { title: "Sito Web", icon: "Store", url: "/app/webhub" },
  ],
  tattoo: [
  ...
  education: [
    ...
    { title: "Staff Docenti", icon: "UserCog", url: "/app/staff" },
    { title: "Recensioni", icon: "Star", url: "/app/reviews" },
    { title: "Sito Web", icon: "Store", url: "/app/webhub" },
  ],
  events: [
...
const COMMON_NAV = [
  ...
  { title: "Lead Scout", icon: "Target", url: "/app/leads" },
