  ...
  return (
    <>
      ...
      >
        ...
        <BackButton to="/" label="Home" variant="navbar" theme="light" className="hidden sm:flex" />
        ...
        {company?.slug && (
          <Button
            ...
            className="gap-1.5 h-8 text-xs border-primary/30 hover:border-primary/60 hover:bg-primary/5 transition-all"
          >
